...
ln -s /opt/mos/codebase/starfish-ws-apollo-${appName}/scripts/index-worker-dev-${appName}-run . > /dev/null 2>&1
ln -s /opt/mos/codebase/starfish-ws-apollo-${appName}/scripts/starfish-ws-apollo-dev-${appName}-run . > /dev/null 2>&1
ln -s /opt/mos/codebase/starfish-ws-apollo-${appName}/scripts/starfish-ws-apollo-inner-dev-${appName}-run . > /dev/null 2>&1

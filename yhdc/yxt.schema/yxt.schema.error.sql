...
-----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS jinpaidingding_errorlog (
	orgid STRING,
	orgname STRING,
	logtitle STRING,
	serverip STRING,
...
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2015', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2016', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2017', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2018', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2019', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2020', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2021', month='12');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='01');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='02');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='03');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='04');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='05');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='06');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='07');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='08');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='09');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='10');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='11');
ALTER TABLE jinpaidingding_errorlog ADD IF NOT EXISTS PARTITION (year='2022', month='12');

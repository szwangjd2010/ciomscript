...
drop database if exists cdh_sentry;
...
create database cdh_sentry default character set utf8;
...
grant all privileges on cdh_sentry.* to cdh_sentry@'%' identified by 'uydc.cmf' with grant option;
